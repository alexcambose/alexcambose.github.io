export const workTimelineData = [
  {
    ...
    description: `Worked on different outsourcing projects and companies, including a US startup.
...
- conducted code reviews to ensure high code standards`,
  ...
  },
  {
    ...
    description: `Worked on different projects over time, DeFi crypto options exchange, DeFi option-based yield generation app, ERC 4337 based DeFi price prediction app using spreads and digital options.
Key Responsibilities:
