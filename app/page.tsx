...
- implemented real-time websocket based communication for different parts of the app`,
    ...
    companyImageUrls: {
      ...
      light: {
        small: `${process.env.VERCEL_URL}/logo/mixdice-small.png`,
        large: `${process.env.VERCEL_URL}/logo/mixdice-large.png`,
      },
      dark: {
        small: `${process.env.VERCEL_URL}/logo/mixdice-small.png`,
        large: `${process.env.VERCEL_URL}/logo/mixdice-large.png`,
...
- achieved seamless integration between frontend and on-chain smart contracts`,
    ...
    companyImageUrls: {
      ...
      light: {
        small: `${process.env.VERCEL_URL}/logo/instantoption-small.svg`,
        large: `${process.env.VERCEL_URL}/logo/instantoption-large.svg`,
      },
      dark: {
        small: `${process.env.VERCEL_URL}/logo/instantoption-small.svg`,
        large: `${process.env.VERCEL_URL}/logo/instantoption-large.svg`,
...
`,
    ...
    companyImageUrls: {
      ...
      light: {
        small: `${process.env.VERCEL_URL}/logo/rolla-small-light.svg`,
        large: `${process.env.VERCEL_URL}/logo/rolla-large-light.svg`,
      },
      dark: {
        small: `${process.env.VERCEL_URL}/logo/rolla-small-light.svg`,
        large: `${process.env.VERCEL_URL}/logo/rolla-large-dark.svg`,
      },
    },
  },
];
