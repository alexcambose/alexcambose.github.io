      ...
      <Row>
        <Col>
          <AboutText>
            ...
            full website design and development from start to finish. I love to
            create smart and beautiful user interfaces, and to imaginate new
            ways of building stuff or solving problems.
          </AboutText>
        </Col>
        <Col>
          <AboutText>
        ...
        <Col>
          <AboutText>
            ...
            probably messing around with hardware stuff or just out for a walk.
          </AboutText>
        </Col>
      </Row>
    </Container>
