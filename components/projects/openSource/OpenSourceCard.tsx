...
export const OpenSourceCard = ({ data }: OpenSourceCardProps) => {
  ...
  return (
    <a href={githubUrl} target="_blank">
      <Panel className="group/item p-3 group-hover:opacity-90 hover:!opacity-100 hover:-translate-y-0.5 transition hover:shadow-lg flex flex-col pointer h-full">
        ...
        <TagList tags={tags} className="dark:text-slate-400 mt-4" />
      </Panel>
    </a>
  );
};
